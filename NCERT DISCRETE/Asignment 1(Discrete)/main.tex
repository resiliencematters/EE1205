...
\author{EE23BTECH11011- Tejas Mehtre$^{*}$% <-this % stops a space
}
\maketitle
...
\end{equation} 
\begin{align}
            \implies X\brak{z}&=9z^{-1}\frac{\brak{1+z^{-1}}}{\brak{1-z^{-1}}^3} + \frac{33}{\brak{1-z^{-1}}^2} +\frac{24}{\brak{1-z^{-1}}} \abs{z}>1    \label{eq:eq5}\\
            Y\brak{z} &= X\brak{z}U\brak{z} \label{eq:eq3} \\
              \implies Y\brak{z}&= \frac{\brak{z}^{-1}\brak{18-9z^2+67}}{\brak{1-z^{-1}}^3} + \frac{\brak{42-9z^{-1}}}{\brak{1-z^{-1}}^2} \label{eq:11.9.4.10.5.eq}
        \end{align}
 ...
 \begin{align}
        ...
        \end{align}
        $\therefore$ Sum of $n$ terms of the series whose $n^{th}$ term is given by $\brak{3n+3}\brak{3n+8}$ is $\frac{33n\brak{n+1}}{2}+\frac{9n\brak{n+1}\brak{2n+1}}{6}+24\brak{n+1}$
