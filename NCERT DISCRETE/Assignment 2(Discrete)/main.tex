...
\end{equation} 
\begin{align}
            \implies X\brak{z}&=\frac{\brak{4z^{-1}}}{\brak{1-z^{-1}}^2} +\frac{10}{\brak{1-z^{-1}}} \abs{z}>1    \label{eq:eq5}\\
            Y\brak{z} &= X\brak{z}U\brak{z} \label{eq:eq3} \\
              \implies Y\brak{z}&= \frac{\brak{4z^{-1}}}{\brak{1-z^{-1}}^3} +\frac{10}{\brak{1-z^{-1}}^2} \abs{z}>1  \label{eq:11.9.4.10.5.eq}
        \end{align}
        Now from~\eqref{eq:11.9.4.10.1.eq},~\eqref{eq:11.9.4.10.2.eq},~\eqref{eq:11.9.4.10.3.eq},~\eqref{eq:11.9.4.10.4.eq},
 ~\eqref{eq:11.9.4.10.5.eq} By using Contour Integration,
    \begin{align}
            y\brak{n}= \brak{2n\brak{n+1}+10\brak{n+1}}u\brak{n}
        \end{align}
        $\therefore$ Sum of $n$ terms of the series whose $n^{th}$ term is given by $\brak{4n+10}u\brak{n}$ is $(2n\brak{n+1}+10\brak{n+1})$u$\brak{n}$
        \begin{figure}[h]
    \centering
